...
export default function Footer({ className, ...props }: FooterProps) {
    return (
        <footer {...props} className={cn("flex justify-center bg-blue-900 pt-12 pb-16 text-white xs:px-10", className)}>
            <div className="w-full whitespace-nowrap lg:max-w-screen-md flex flex-col gap-8">
...
function FooterBar() {
    return <div className="h-[3px] w-full rounded-full bg-gradient-to-tr from-blue-300 to-blue-500" />;
}
