            ...
            <div className="*:h-6 *:min-w-6">
                {item.checked ? (
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
                        ...
                        <path d="M10 18L18 10" stroke="#E63058" stroke-width="3" stroke-linecap="round" />
                        <path d="M18 18L10 10" stroke="#E63058" stroke-width="3" stroke-linecap="round" />
                    </svg>
                )}
            </div>
