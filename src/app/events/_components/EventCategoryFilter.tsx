    ...
    return (
        <div className="justify-start items-center gap-[18px] flex">
            ...
            <div className="justify-start items-center gap-3 flex">
                ...
                <div className="px-5 py-2 bg-purple-100 rounded-[999px] border-2 border-purple-400 justify-start items-start gap-2.5 flex overflow-hidden transition will-change-auto duration-500 hover:duration-200 hover:bg-purple-150 hover:rotate-[9deg] cursor-pointer">
