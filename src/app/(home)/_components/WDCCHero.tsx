            ...
            <div className="flex w-[clamp(300px,100%,1000px)] flex-col items-center gap-10 self-center px-8 text-center">
                <div className="flex flex-col gap-6 sm:gap-2">
                    <motion.h3
                        ...
                        className="text-sm font-normal leading-none tracking-[0.25em] text-blue-800 sm:text-base">
                        {hero.title}
                    </motion.h3>
                    <motion.h1
                ...
                <motion.div className="flex flex-col items-center gap-6 self-center">
                    ...
                    <motion.div animate={{ y: [64, 0], transition: transition }}
                                className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                        <Button variant={{ style: "primary", color: "blue" }} href="https://docs.google.com/forms/d/e/1FAIpQLSf9p1n1GpuuFxXbhx_7iWDQkDqRpxVDAjUOeyyzYeavC6d48A/viewform?usp=sharing">Become a member for 2025</Button>
