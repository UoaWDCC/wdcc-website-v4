        ...
        <div ref={ref} className="relative flex w-full flex-col gap-20 items-center justify-center">
            <div className="flex w-[clamp(300px,100%,1000px)] flex-col gap-10 items-center self-center px-8 text-center">
                <div className="flex flex-col gap-6 sm:gap-2">
                    <h3 className="text-sm sm:text-base font-normal tracking-[0.25em] text-blue-800 leading-none">WEB DEVELOPMENT AND
                        CONSULTING CLUB</h3>
                    <h1 className="text-4xl sm:text-5xl font-bold tracking-[-2px] text-blue-700 leading-[0.95]">
                        Aotearoa’s
                        <em> largest </em>
                ...
                <div className="flex flex-col gap-6 items-center self-center">
                    <p className="text-md sm:text-lg text-blue-700 leading-tight">
