...
export default function PMPage() {
    ...
    return (
        // Yes I know it's orange. Contrast with yellow is bad so just deal with it.
        <StandardPageLayout className="bg-orange-500" navColor="dark">

            <RiveToggleButton animEnabled={animEnabled} setAnimEnabled={setAnimEnabled}/>

            <RolesHeader
                variant={{ color: "yellow" }}
                title="Lead to succeed as a WDCC Project Manager"
            ...
            <div className="flex flex-col gap-46 pt-2 pb-32 text-white">
                <div className="flex flex-col gap-20">
                    <div className="flex flex-col gap-8 text-center">
                        <h2 className=" font-bold text-4xl leading-[1.1]">practice fantastic things.</h2>
                        <div className="grid gap-12 sm:gap-8 md: gap-4 lg:grid-cols-3 sm:grid-cols-2">
                            <LearnCard title={"teamwork"}
                                       ...
                                       graphic={graphic1}/>
                            <LearnCard title={"research"}
                                       description={"understanding client needs, working with feedback, and participating in a designer-developer process."}
                                       graphic={graphic2}/>
                            <LearnCard title={"design"}
                                       description={"make something beautiful for the world around you. improve your design theory, presentation skills, and creative craft."}
                                       graphic={graphic3}/>
                ...
                <div className="flex flex-col gap-28">
                    ...
                    <RiveDuo rive={{ src: "/rive/wdcc_designer_2.riv", isPlaying: animEnabled }}>
                        <h3 className="font-bold text-2xl leading-none">Design something real.</h3>
                    ...
                    <RiveDuo imgFirst={true} rive={{ src: "/rive/wdcc_designer_3.riv", isPlaying: animEnabled }}
                        ...
                        <p className="text-md leading-tight">You’ll be working in a realistic tech team following an
                            Agile
                            format with several other developers, leads, and project managers. You’ll learn to balance
                            the
                            designer-developer relationship and gain a practical understanding of design in a tech
                            environment.</p>
                    </RiveDuo>
                    <RiveDuo  rive={{src: "/rive/wdcc_designer_4.riv", isPlaying: animEnabled}} largeAnim>
                        <h3 className="font-bold text-2xl leading-none">Make your portfolio sparkle.</h3>
                        <p className="text-md leading-tight">Project teams deliver apps, tools, and websites that have a real impact on your portfolio and CV.</p>
                        <p className="text-md leading-tight">The products you work on get deployed into real-world use, helping hundreds of other students, staff, and community members do all kinds of things. </p>
                        <p className="text-md leading-tight">At the end of the day, WDCC Projects are things you can point at in job interviews and say `&quot;I made that, and you can use it`&quot;.</p>
                    </RiveDuo>
                </div>

                <MoreAboutProjects>
                    <p className="text-md leading-tight">
                        WDCC Projects are about more than design. Learn more about projects and how they work on these pages:
                    </p>
                </MoreAboutProjects>
