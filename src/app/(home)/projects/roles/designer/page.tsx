        ...
        <StandardPageLayout className="bg-purple-500" navColor="dark">
            ...
            <div className="flex flex-col gap-42 pb-32 text-white responsive-fullwidth">
                <div className="flex flex-col gap-2 justify-center items-center w-screen">
                    ...
                    <div className=" w-full mx-auto h-[850px]">
            ...
            <div className="flex flex-col gap-46 pt-2 pb-32 text-white">
                <div className="flex flex-col gap-20">
                    <div className="flex flex-col gap-8 text-center">
                        <h2 className=" font-bold text-4xl">practice fantastic things.</h2>
                        <div className="flex gap-4">
                ...
                <div className="flex flex-col gap-28">
                    ...
                    <RiveDuo rive={{src: "/rive/wdcc_designer_2.riv", isPlaying: animEnabled}}>
                        <h3 className="font-bold text-2xl leading-tight">Design something real.</h3>
                    ...
                    <RiveDuo imgFirst={true}  rive={{src: "/rive/wdcc_designer_3.riv", isPlaying: animEnabled}} largeAnim>
                        <h3 className="font-bold text-2xl leading-none">Learn the tools of the trade.</h3>
                        <p className="text-md leading-tight">WDCC design teams use the same industry-standard tools and
                            processes - from Figma to Jira - as real companies do.</p>
                ...
                <MoreAboutProjects>
                    <p>
                        Projects are about more than design. Learn more about projects and how they work on these pages:
                    </p>
                </MoreAboutProjects>
